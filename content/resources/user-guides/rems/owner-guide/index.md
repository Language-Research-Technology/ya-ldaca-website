...
> You can automatically reject new applications from denied users by adding Rejecter Bot in the Handler field of the resource's workflow (see [5 Workflows](#5-workflow)).
